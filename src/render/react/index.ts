...
import { CanvasComp, CanvasProps } from "./components/Canvas/comp";
import CanvasConfig from "./components/Canvas/config";
...
export const Canvas = registerComponent<CanvasProps, CanvasComp>(new CanvasConfig());
